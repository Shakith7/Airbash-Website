    ...
    <section className="relative bg-black text-white h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 h-full flex flex-col justify-center items-center text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
          <a
            href="/book"
            className="px-6 py-3 bg-primary text-black font-bold uppercase rounded hover:bg-lime-500 transition"
          >
            Book Your Space
          </a>
          <a
            href="/join"
            className="px-6 py-3 border-2 border-primary text-primary font-bold uppercase rounded hover:bg-primary hover:text-black transition"
          >
            Join Our Team
          </a>
        </div>
